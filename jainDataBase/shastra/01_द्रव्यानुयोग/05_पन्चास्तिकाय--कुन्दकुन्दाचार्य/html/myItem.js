...
$( document ).ready(function() {
  ...
  mySel.append($optgrp);
    $optgrp=$('<optgroup label="﻿मंगलाचरण">')
       $optgrp.append("<option value='001.html'><b>001</b> - ﻿देव नमस्कार गाथा</option>");
  mySel.append($optgrp);
    $optgrp=$('<optgroup label="﻿द्रव्य-सामान्य">')
       $optgrp.append("<option value='002.html'><b>002</b> - ﻿आगम-नमस्कार और ग्रन्थ-रचना की प्रतिज्ञा</option>");
       $optgrp.append("<option value='003.html'><b>003</b> - ﻿पंचास्तिकाय-संक्षिप्त व्याख्यान</option>");
       $optgrp.append("<option value='004.html'><b>004</b> - ﻿अब पाँच अस्तिकायों के विशेष नाम, सामान्य-विशेष अस्तित्व और कायत्व का प्रतिपादन करते हैं</option>");
       $optgrp.append("<option value='005.html'><b>005</b> - ﻿अब पूर्वोक्त अस्तित्व और कायत्व किसप्रकार से सम्भव इसका प्रकृष्ट रूप में ज्ञान कराते हैं</option>");
       $optgrp.append("<option value='006.html'><b>006</b> - ﻿काल सहित पन्चास्तिकायों की द्रव्य संज्ञा</option>");
       $optgrp.append("<option value='007.html'><b>007</b> - ﻿संकर व्यतिकर दोष परिहार</option>");
       $optgrp.append("<option value='008.html'><b>008</b> - ﻿सामान्य-विशेष सत्ता लक्षण</option>");
       $optgrp.append("<option value='009.html'><b>009</b> - ﻿सत्ता-द्रव्य में अभेद, 'द्रव्य' शब्द की व्युपत्ति</option>");
       $optgrp.append("<option value='010.html'><b>010</b> - ﻿द्रव्य के तीन लक्षण</option>");
       $optgrp.append("<option value='011.html'><b>011</b> - ﻿तीनों लक्षणों का प्रतिपादन</option>");
       $optgrp.append("<option value='012.html'><b>012</b> - ﻿अब निश्चय से द्रव्य-पर्यायों का अभेद दिखाते हैं</option>");
       $optgrp.append("<option value='013.html'><b>013</b> - ﻿अब निश्चय से द्रव्य और गुणों के अभेद का समर्थन करते हैं</option>");
       $optgrp.append("<option value='014.html'><b>014</b> - ﻿प्रमाण सप्त-भंगी</option>");
       $optgrp.append("<option value='015.html'><b>015</b> - ﻿बौद्ध-मत एकान्त निराकरणार्थ द्रव्य स्थापन मुख्यता सूचक</option>");
       $optgrp.append("<option value='016.html'><b>016</b> - ﻿उस अधिकार गाथा का विवरण</option>");
       $optgrp.append("<option value='017.html'><b>017</b> - ﻿अब पर्यायार्थिक-नय से उत्पाद-विनाश होने पर भी द्रव्यार्थिकनय से उत्पाद-विनाश नहीं होते हैं; इसका समर्थन करते हैं</option>");
       $optgrp.append("<option value='018.html'><b>018</b> - ﻿अब उसी अर्थ को दो नयों द्वारा और भी दृ़ढ करते हैं</option>");
       $optgrp.append("<option value='019.html'><b>019</b> - ﻿अब इस प्रकार यह सिद्ध हुआ कि द्रव्यार्थिक-नय से सत का विनाश नहीं है और असत का उत्पाद नहीं है, इसे निश्चित करते हैं</option>");
       $optgrp.append("<option value='020.html'><b>020</b> - ﻿पर्यायार्थिक-नय की अपेक्षा सिद्धों के असदुत्पाद </option>");
  ...
  mySel.append($optgrp);
    $optgrp=$('<optgroup label="﻿जीवास्तिकाय">')
       ...
       $optgrp.append("<option value='031-032.html'><b>031-032</b> - ﻿अब अगुरुलघुत्व, असंख्यात प्रदेशत्व, व्यापकत्व, अव्यापकत्व, मुक्त और अमुक्तत्व का प्रतिपादन करते हैं</option>");
       $optgrp.append("<option value='033.html'><b>033</b> - ﻿जीव का स्व-देह-प्रमाणत्व ज्ञापन</option>");
       $optgrp.append("<option value='034.html'><b>034</b> - ﻿अब वर्तमान शरीर के समान पूर्वापर शरीर की परम्परा होने पर भी उसी जीव का अस्तित्व, देह से पृथक्त्व और भवान्तर (दूसरे भव में) गमन का कारण कहते हैं</option>");
       $optgrp.append("<option value='035.html'><b>035</b> - ﻿जीव का अमूर्तत्व ज्ञापन </option>");
       $optgrp.append("<option value='036.html'><b>036</b> - ﻿अब सिद्ध के कर्म-नोकर्म की अपेक्षा कार्य-कारण-भाव साधते हैं</option>");
       $optgrp.append("<option value='037.html'><b>037</b> - ﻿अब 'जीव का अभाव मुक्ति है' इसप्रकार के सौगतमत का विशेषरूप से निराकरण करते हैं</option>");
       $optgrp.append("<option value='038.html'><b>038</b> - ﻿अनादि चैतन्य समर्थन व्याख्यान </option>");
       $optgrp.append("<option value='039.html'><b>039</b> - ﻿अब यहाँ कौन क्या चेतता है ? इसका निरूपण करते हैं । प्रश्न - निरूपण करते हैं इसका क्या अर्थ है?  उत्तर - तत्सम्बन्धी प्रश्न होने पर उसका उत्तर देते हैं यह उसका अर्थ है। इसप्रकार प्रश्नोत्तररूप पातनिका के प्रस्ताव में सर्वत्र 'इति' शब्द का अर्थ जानना चाहिए-</option>");
       $optgrp.append("<option value='040.html'><b>040</b> - ﻿ज्ञान-दर्शन दो उपयोग सूचक</option>");
       $optgrp.append("<option value='041.html'><b>041</b> - ﻿आठ प्रकार का ज्ञानोपयोग</option>");
       $optgrp.append("<option value='048.html'><b>042</b> - ﻿चक्षु आदि चार दर्शन</option>");
       $optgrp.append("<option value='049.html'><b>043</b> - ﻿संक्षेप में जीव ज्ञान की अभेदता</option>");
       $optgrp.append("<option value='050.html'><b>044</b> - ﻿अब द्रव्य का गुणों से सर्वथा प्रदेशास्तित्व रूप भेद होने पर तथा गुणों का द्रव्य से भेद होने पर दोष दिखाते हैं</option>");
       $optgrp.append("<option value='051.html'><b>045</b> - ﻿अब, द्रव्य-गुणों के यथोचित (कथंचित्) अभिन्न प्रदेश रूप अनन्यता प्रदर्शित करते हैं</option>");
       $optgrp.append("<option value='052.html'><b>046</b> - ﻿भेद में भी कथंचित अभेद का समर्थन</option>");
       $optgrp.append("<option value='053.html'><b>047</b> - ﻿अब, निश्चय से भेदाभेद का उदाहरण कहा जाता है</option>");
       $optgrp.append("<option value='054.html'><b>048</b> - ﻿अब ज्ञान और ज्ञानी के अत्यन्त भेद में दोष दिखाते हैं</option>");
       $optgrp.append("<option value='055.html'><b>049</b> - ﻿नैयायिक मानी समवाय सम्बन्ध का निषेध</option>");
       $optgrp.append("<option value='056.html'><b>050</b> - ﻿अब गुण-गुणी के कथंचित् एकत्व को छोड़कर अन्य कोई भी समवाय नहीं है, ऐसा समर्थन करते हैं</option>");
       $optgrp.append("<option value='057-058.html'><b>051-052</b> - ﻿अब दृष्टान्त और दार्ष्टान्त रूप से द्रव्य-गुणों के कथंचित् अभेद परक व्याख्यान का उपसंहार करते हैं</option>");
       $optgrp.append("<option value='059.html'><b>053</b> - ﻿आगे जिन जीवों के कर्म का कर्तृत्व, भोक्तृत्व, संयुक्तत्व -- ये तीन कहे जायेंगे; पहले उनके स्वरूप और संख्या का प्रतिपादन करते हैं</option>");
       $optgrp.append("<option value='060.html'><b>054</b> - ﻿अब यद्यपि पर्यायार्थिक नय से विनाश-उत्पाद होते हैं, तथापि द्रव्यार्थिक नय से नहीं होते हैं; ऐसा होने पर भी पूर्वापर विरोध नहीं है, ऐसा कहते हैं</option>");
       ...
       $optgrp.append("<option value='070.html'><b>064</b> - ﻿परिहार गाथाएं - द्रव्य कर्मों का करता जीव नहीं</option>");
...
$( document ).ready(function() {
  ...
  mySel.append($optgrp);
    $optgrp=$('<optgroup label="﻿जीवास्तिकाय">')
       ...
       $optgrp.append("<option value='040.html'><b>040</b> - ﻿ज्ञान-दर्शन दो उपयोग सूचक</option>");
       $optgrp.append("<option value='041.html'><b>041</b> - ﻿आठ प्रकार का ज्ञानोपयोग</option>");
       $optgrp.append("<option value='042.html'><b>042</b> - ﻿मति आदि पाँच प्रकार का सम्यग्ज्ञान</option>");
       ...
       $optgrp.append("<option value='048.html'><b>048</b> - ﻿चक्षु आदि चार दर्शन</option>");
       $optgrp.append("<option value='049.html'><b>049</b> - ﻿संक्षेप में जीव ज्ञान की अभेदता</option>");
       $optgrp.append("<option value='050.html'><b>050</b> - ﻿अब द्रव्य का गुणों से सर्वथा प्रदेशास्तित्व रूप भेद होने पर तथा गुणों का द्रव्य से भेद होने पर दोष दिखाते हैं</option>");
       $optgrp.append("<option value='051.html'><b>051</b> - ﻿अब, द्रव्य-गुणों के यथोचित (कथंचित्) अभिन्न प्रदेश रूप अनन्यता प्रदर्शित करते हैं</option>");
       $optgrp.append("<option value='052.html'><b>052</b> - ﻿भेद में भी कथंचित अभेद का समर्थन</option>");
       $optgrp.append("<option value='053.html'><b>053</b> - ﻿अब, निश्चय से भेदाभेद का उदाहरण कहा जाता है</option>");
       $optgrp.append("<option value='054.html'><b>054</b> - ﻿अब ज्ञान और ज्ञानी के अत्यन्त भेद में दोष दिखाते हैं</option>");
       $optgrp.append("<option value='055.html'><b>055</b> - ﻿नैयायिक मानी समवाय सम्बन्ध का निषेध</option>");
       $optgrp.append("<option value='056.html'><b>056</b> - ﻿अब गुण-गुणी के कथंचित् एकत्व को छोड़कर अन्य कोई भी समवाय नहीं है, ऐसा समर्थन करते हैं</option>");
       $optgrp.append("<option value='057-058.html'><b>057-058</b> - ﻿अब दृष्टान्त और दार्ष्टान्त रूप से द्रव्य-गुणों के कथंचित् अभेद परक व्याख्यान का उपसंहार करते हैं</option>");
       $optgrp.append("<option value='059.html'><b>059</b> - ﻿आगे जिन जीवों के कर्म का कर्तृत्व, भोक्तृत्व, संयुक्तत्व -- ये तीन कहे जायेंगे; पहले उनके स्वरूप और संख्या का प्रतिपादन करते हैं</option>");
       $optgrp.append("<option value='060.html'><b>060</b> - ﻿अब यद्यपि पर्यायार्थिक नय से विनाश-उत्पाद होते हैं, तथापि द्रव्यार्थिक नय से नहीं होते हैं; ऐसा होने पर भी पूर्वापर विरोध नहीं है, ऐसा कहते हैं</option>");
       ...
       $optgrp.append("<option value='070.html'><b>070</b> - ﻿परिहार गाथाएं - द्रव्य कर्मों का करता जीव नहीं</option>");
