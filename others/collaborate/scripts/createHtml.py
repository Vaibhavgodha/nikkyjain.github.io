...
for gatha in myMainFIles:
    ...
    """)
    if(myPrevGatha!=""):
        html.write("<a href='"+myPrevGatha+"' rel=external><img src='"+myRelPath+"images/common/prev.jpg' height=50 width=50/></a>")
    if(myNextGatha!=""):
...
#                fData=re.sub(r'<br>$', '', fData); 
                ...
                if(sTeeka):
                    ...
                    html.write("<div class=steeka id=steeka"+str(myCntr)+">"+sfData+"</div>")
